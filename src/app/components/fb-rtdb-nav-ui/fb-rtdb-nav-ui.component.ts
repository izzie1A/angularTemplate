...
@Component({
  selector: 'app-fb-rtdb-nav-ui',
  templateUrl: './fb-rtdb-nav-ui.component.html',
  styleUrls: ['./fb-rtdb-nav-ui.component.css']
})
export class FbRtdbNavUiComponent implements OnInit {
  container:any[]
  containerChild:any[]
